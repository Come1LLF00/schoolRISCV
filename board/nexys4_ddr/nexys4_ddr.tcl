...
set top_sim_module "sm_testbench"
...
set constraints_dir "$origin_dir/project"

# The directory that the Verilog source files are located.
set verilog_dir "$origin_dir/../../src"

# The directory that the simulation files are located.
set sim_dir "$origin_dir/../../testbench"
